...
public class PlacesHyderabad {

	public PlacesHyderabad() {
		String p1=" Birla Mandir is a Hindu temple, built on a 280 feet (85 m) high hillock called Naubath Pahad on a 13 acres (53,000 m2) plot. The construction took 10 years and was constructed in 1976 by Swami Ranganathananda of Ramakrishna Mission. The temple was constructed by Birla Foundation, which has also constructed several similar temples across India, all of which are known as Birla Mandir.";
		String im1 = ".//img//Hyderabad//tourism//birlamandir.jpg";

		String p2="Makkah Masjid, is one of the oldest mosques in Hyderabad, Telangana in India, and it is one of the largest masajids in India. Makkah Masjid is a listed heritage building in the old city of Hyderabad, close to the historic landmarks of Chowmahalla Palace, Laad Bazaar, and Charminar. ";
		String im2 = ".//img//Hyderabad//tourism//Makkah Masjid.jpeg";
