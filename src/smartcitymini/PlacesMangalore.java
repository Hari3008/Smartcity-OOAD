...
public class PlacesMangalore {
	...
	public PlacesMangalore() {
		...
		String p5="Malpe is a natural port about six kilometers to the west of Udupi, Karnataka, India. An important port and fishing harbor on the Karnataka coast. It is a suburb in Udupi city . Malpe and the Mogaveera goes together. Malpe is a hub of Mogaveera population. Inhabitant for the millionaire businessmen of Mogaveera community. Tulu, Kannada and Konkani are spoken here. first Indian beach with 24/7 WiFi";
		String im5 = ".//img//Mangalore//malpe beach.jpg";
		
		String p6=" Kadri Manjunatha Temple is located in Mangalore in the state of Karnataka, India, was originally made by Vajrayana Buddhist but later on due to fall of Buddhism converted for the deity Manjunatha by Hindus.";
		String im6 = ".//img//Mangalore//kadrimanjunath.jpg";
