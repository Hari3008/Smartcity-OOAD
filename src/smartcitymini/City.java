...
//		SetImageSize(disp1,new ImageIcon());
        ...
        String text3="Mangalore, officially known as Mangaluru, is the chief port city of the Indian state of Karnataka. It is known as Kudla in Tulu, Mangaluru in Kannada, MaikÄ�la in Beary, and Kodial in Canarese Konkani. It is located about 371 kilometres (230 mi) west of the state capital, Bangalore. Mangalore lies between the Arabian Sea and the Western Ghat mountain ranges, and is the administrative headquarters of the Dakshina Kannada (formerly South Canara) district in south western Karnataka. With its pristine beaches, broad roads and calm localities, Mangalore was ranked the 8th cleanest city of India and 2nd of Karnataka. Mangalore is the 2nd least polluted city in India and the 1st in Karnataka according to CPCB. Mangalore was ranked India's 13th and Karnataka's 2nd best destination for business.";
       ...
       /* textArea_4.setBackground(Color.WHITE);
        ...
        String text5="Hyderabad is the capital of the southern Indian state of Telangana and de jure capital of Andhra Pradesh.[A] Occupying 650 square kilometres (250 sq mi) along the banks of the Musi River, it has a population of about 6.7 million and a metropolitan population of about 7.75 million, making it the fourth most populous city and sixth most populous urban agglomeration in India. At an average altitude of 542 metres (1,778 ft), much of Hyderabad is situated on hilly terrain around artificial lakes, including Hussain Sagarâ€”predating the city's foundingâ€”north of the city centre.";
