...
public class Hyderabad extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Hyderabad frame = new Hyderabad("Student");
	...
	public Hyderabad(String role) {
       ...
       JButton Hotel = new JButton("Restaurants");
        ...
        Lodging.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent arg0) {
        		if(role_Hyderabad=="Tourist" || role_Hyderabad=="JobSeeker") {
        		BLHyd bl = new BLHyd();
        		}
        		else {
        ...
        Business.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent arg0) {
        		if(role_Hyderabad=="JobSeeker") {
        		JobsHyd j = new JobsHyd();
        		}
        		else {
        ...
        Hotel.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent arg0) {
        		if(role_Hyderabad=="Tourist"){
        		HotelsHyd h = new HotelsHyd();
        		}
        		else {
        ...
        Tourism.addMouseListener(new MouseAdapter() {
        	...
        	public void mouseClicked(MouseEvent e) {
                if(role_Hyderabad=="Tourist") {
                	...
                	PlacesHyderabad t=new PlacesHyderabad(); 
                }
                else {
					JOptionPane.showMessageDialog(null,"No access for Non-Tourists");
                }
				...
				try{
					while(true)
					{
						...
						case 0 : 
							    ...
							    ImageIcon i1=new ImageIcon(".//img//slide//hyd3.jpg");
						        bslide1.setIcon(i1);
						        bslide1.setVisible(true);
						        Thread.sleep(2000);
					    ...
					    ImageIcon i2=new ImageIcon(".//img//slide//hyd4.jpeg");
				        bslide2.setIcon(i2);
				        bslide2.setVisible(true);
				        Thread.sleep(2000);
						...
						break;
						case 2: 
					    ImageIcon i3=new ImageIcon(".//img//slide//hyd3.jpg");
				        bslide1.setIcon(i3);
				        bslide1.setVisible(true);
				        Thread.sleep(2000);
				        AC.jLabelXLeft(0,-840,20,7, bslide1);
						...
						break;
						case 3: 
					    ImageIcon i4=new ImageIcon(".//img//slide//hyd4.jpeg");
				        bslide2.setIcon(i4);
				        bslide2.setVisible(true);
				        Thread.sleep(2000);
				        AC.jLabelXRight(-840,0,20,7, bslide1);
						...
						break;
						case 4: 
					    ImageIcon i5=new ImageIcon(".//img//slide//hyd3.jpg");
				        bslide1.setIcon(i5);
				        bslide1.setVisible(true);
				        Thread.sleep(2000);
				        AC.jLabelXLeft(0, -840,20,7, bslide1);
